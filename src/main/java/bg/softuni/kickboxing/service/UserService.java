...
public class UserService {
    ...
    public UserService(UserRepository userRepository, UserRoleService userRoleService, ModelMapper mapper, PasswordEncoder passwordEncoder, UserDetailsService userDetailsService) {
